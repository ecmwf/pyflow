...
class Task(Node):
    ...
    def __init__(
        self, name, autolimit=True, submit_arguments=None, exit_hook=[], clean_workdir=False, **kwargs
    ):
        """
        ...
        self._exit_hook = [exit_hook] if isinstance(exit_hook, str) else exit_hook
